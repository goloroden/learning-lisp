...
Alternatively you can use `case` that compares an expression against a list of values using `eq`. Again, the last branch is specified by `otherwise`. Hence, its canonical form is:
